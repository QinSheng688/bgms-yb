...
<div class="lyear-layout-web">
    <div class="lyear-layout-container">
                    ...
                    <ul class="nav nav-drawer">
                        <c:forEach items="${menuList}" var="menu">
                            <li
                             ...
                             >
                                <a href="javascript:void(0)"onclick="jump('${menu.href}')"><i class="mdi mdi-menu"></i> ${menu.title}</a>
                                <c:if test="${not empty menu.list}">
                                    <ul class="nav nav-subnav">
                                        <c:forEach items="${menu.list}" var="menulist">
                                            <li
                                                    class="nav-item nav-item-has-subnav"
                                            >
                                                <a href="#!"onclick="jump('${menulist.href}')">${menulist.title}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </c:if>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title">${menu.title} </span>
                    </div>
        ...
        <c:if test="${flag=='manage'}">
            <%@include file="user_manage.jsp"%>
        </c:if>
        <c:if test="${flag=='role'}">
            <%@include file="role_manage.jsp"%>
        </c:if>
        <c:if test="${flag=='home'}">
